...
class TestOpenAIUploader(unittest.TestCase):
    ...
    @patch('src.uploader.openai_uploader.config')
    @patch('src.uploader.openai_uploader.OpenAI')
    @patch('src.uploader.openai_uploader.Path')
    def test_upload_missing_stage_file(self, mock_path_cls, mock_openai, mock_config):
        mock_config.OPENAI_API_KEY = "test_key"
    ...
    @patch('src.uploader.openai_uploader.OpenAI')
    @patch('src.uploader.openai_uploader.Path')
    def test_upload_empty_stage_file_no_action(self, mock_path_cls, mock_openai, mock_config):
        mock_config.OPENAI_API_KEY = "test_key"
        mock_stage_path = MagicMock()
        ...
        with patch('src.uploader.openai_uploader.open', m_open):
            with patch('builtins.print') as mock_print:
    ...
    @patch('src.uploader.openai_uploader.OpenAI')
    @patch('src.uploader.openai_uploader.Path')
    def test_upload_creates_new_vector_store(self, mock_path_cls, mock_openai, mock_config):
        mock_config.OPENAI_API_KEY = "test_key"
    ...
    @patch('src.uploader.openai_uploader.OpenAI')
    @patch('src.uploader.openai_uploader.Path')
    def test_upload_modifies_and_deletes(self, mock_path_cls, mock_openai, mock_config):
        mock_config.OPENAI_API_KEY = "test_key"
    ...
    def test_upload_retry_logic(self, mock_sleep, mock_path_cls, mock_openai, mock_config):
        mock_config.OPENAI_API_KEY = "test_key"
